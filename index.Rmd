...
```{r, include=FALSE}
library(readr)
martes <- as.Date ("2026-08-11")
viernes <- as.Date("2026-08-14")
...
dzayat@derecho.uba.ar<br>
Ayudante de 2da:  Tamara London
tamaralondon@derecho.uba.ar
...
Nuestro sistema jurídico presupone que cualquier persona podrá realizar una demanda ante los tribunales cuando sus derechos hayan sido afectados, vulnerados o amenazados. Este presupuesto asume que el Poder Judicial podrá entender y propender a la solución de cualquier conflicto de derechos que se le presente. Sin embargo, existen diversas razones que hacen que los tribunales de justicia y la protección judicial no sea accesible de modo igualitario para todas las personas. Algunas tendrán muchas menos dificultades para hacerlo y otras deberán vencer muchas más barreras para poder hacer llegar su reclamo a los jueces.
...
Sin embargo, también existen supuestos de grupos con mayores dificultades para hacer valer sus derechos ya no por una normativa expresa sino por una situación social, y diversas prácticas de los operadores judiciales y estatales en general. Estos casos son más dificiles de identificar, aunque inciden de un modo de mayor performatividad, siendo complicado desestabilizar la situación existente. Muchas veces puede verse que la respuesta judicial resulta patriarcal, xenófoba, racista, hegemónica, etc.

En este curso haremos una revisión sobre la normativa constitucional involucrada en el derecho de acceso a la justicia, tomaremos nota de las garantías procesales que establece la constitución para su eficacia, y analizaremos de modo crítico y con casos concretos cómo y por qué existen grupos identitarios de población que suele tener mayores dificulades de acceso a los tribunales.

## Objetivo

El objetivo del curso es visibilizar, discutir y analizar de modo crítico las diversas barreras que afectan al acceso a la justicia, sus aspectos centrales, y su dimensión estructural. La idea es poder analizar problemas jurídicos desde el punto de vista del acceso a la justicia y decidir estrategias para superarlas.
...
Se espera que les estudiantes puedan leer la bibliografía indicada de modo previo a cada clase, y que los encuentros funcionen  no para repetir sino para debatir sobre la literatura indicada.
...
### `r advdate(viernes, 3)`. No hay clases. 
...
-   Expediente judicial Vanesa Gómez - CAF 067668/2018 [retencion](https://drive.google.com/file/d/1MszNbvuQgl56ukSCbql4ggAAKyiia5Bs/view?usp=sharing), [captura](https://drive.google.com/file/d/11RSJ0lXuMKwhQy-gVHfODbc-AH1fBE0j/view?usp=sharing) y [apelacion](https://drive.google.com/file/d/1xsXyT2y3F7sGL8yhK8kG6GTfhkYi7nVw/view?usp=sharing)

<!-- - CSJN Fallo "CSG" 2022 [aca](https://drive.google.com/file/d/140Y3EfDch2yJB085qbQqHJ-ea_yBDfOq/view?usp=sharing)   AGREGAR PARA EL PROXIMO CURSO, QUE ES COMO VANESSA PERO BIEN RESUELTO-->
...
- CSJN, Fallo "Ramírez Balbuena" [aca](https://drive.google.com/file/d/1Ywkky3GM7QkgfrJzKadus-wxZKdKI1aj/view?usp=sharing)

- DNU 366/2025 [aca](https://servicios.infoleg.gob.ar/infolegInternet/anexos/410000-414999/413297/norma.htm) 
...
### `r advdate(viernes, 5)`. Unidad 3. La práctica - Salud Mental - Niñeces
...
- Sala 1 Camara CCF [Ayelen Juve](https://drive.google.com/file/d/1aFR9ckFc2ht1XPg3CwnsxOWkKyU5Na_B/view?usp=sharing)
...
e. Niñeces
  ...
  - Fallo Camara Apelaciones Penal Juvenil CABA, 6/4/2025, [aca](https://drive.google.com/file/d/1aXssgEyYJ8y3i_Vc8h3LngVQcR3PCvnb/view?usp=sharing)




### `r advdate(viernes, 6)`. Unidad 3. La práctica - Mujeres
...
-   Inecip, casos de violencia de género, [aca](https://inecip.org/publicaciones/herramientas-jurisprudenciales-para-el-litigio-con-perspectiva-de-genero/). Leer la introducción y las fichas 1, 2, 3, 5 y 6.
...
- CEDAW, comunicacion 88/2015 - Sra X c. Timor Lester [aca](https://drive.google.com/file/d/1eyLvEJwr0kHy8xZMDpxbthoBAkPDBps0/view?usp=sharing)

  <!-- [(Esta es la guía de litigio en casos de legítima defensa que le comenté a algunes el otro día: [Guia](https://www2.ministeriodelasmujeres.gba.gob.ar/comunicacion/archivos/uploads/6925efbb1b91a9.78294898_Gu__a_para_el_litigio_en_casos_de_mujeres_y_LGBTI_.pdf))]{.red} -->
...
### `r advdate(martes, 7)`. Unidad 3. La práctica - LGBTIQ+
...
-   Informe sombra CEDAW 2026, [aca](https://drive.google.com/file/d/1-MXugF9SyQNYE-aD3kk4VbEC-W0ZqdvX/view?usp=sharing)
...
- Caso Corte IDH, Vicky Hernandez c/ Honduras [sentencia](https://www.corteidh.or.cr/docs/casos/articulos/seriec_422_esp.pdf) y [resumen](https://www.corteidh.or.cr/docs/casos/articulos/resumen_422_esp.pdf) y [video](https://www.youtube.com/watch?v=5AXht8vR6l8) a partir del minuto 40.
...
### `r advdate(viernes, 7)`. Unidad 3. La práctica - Afrodescendientes

e. Afrodescendientes y africanos
...
- CSJN, Fallo Coronel, Gustavo Javier, [aca](https://drive.google.com/file/d/1kslBUCofBjqzYSqUjl-dV5q7sZo_unnV/view?usp=sharing)
...
<footer>
[📧 Suscribirse a la lista de difusión del curso](https://groups.google.com/g/accesojusticia/members){.btn .btn-default}
</footer>
