...
```{r, include=FALSE}
library(readr)
martes <- as.Date ("2026-03-10")
viernes <- as.Date("2026-03-13")
...
### [`r advdate(martes, 3)`  Feriado 24 de marzo. Día de la Memoria, por la verdad y la justicia]{.bordo}
...
### [`r advdate(viernes, 4)`.  Feriado - Viernes Santo]{.bordo}
...
### `r advdate(viernes, 5)`. Unidad 3. La práctica- Discapacidad
...
### `r advdate(martes, 6)`. Unidad 3. La práctica - Salud Mental - Niñeces
...
### [`r advdate(viernes, 8)`. Feriado - Dia del Trabajador/a]{.bordo} 
