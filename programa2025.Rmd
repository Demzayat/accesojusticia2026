...
```{r, include=FALSE}
library(readr)
martes <- as.Date ("2025-08-19")
viernes <- as.Date("2025-08-22")
...
### `r advdate(viernes, 2)`. Unidad 3. La Agenda estructural - Víctimas
...
### `r advdate(martes, 3)`. Unidad 3. La práctica - Migrantes
...
### `r advdate(viernes, 3)`. Unidad 3. La práctica - Situación de Calle
...
### `r advdate(viernes, 4)`. Paro. hacemos Virtual


Terminamos Personas con discapacidad (Asoc. Francesa e Institutos Antártida) y ejecucionoes contra el estado,  y empezamos con R.M.J 

### Unidad 3. La práctica - Salud Mental

- CSJN, "R. M.J s/Insania", [aca](https://drive.google.com/file/d/1c29zw3cQDmwNGuO-GDR15KUq7Xc-UZJb/view?usp=sharing)


### `r advdate(martes, 5)`. Unidad 3. La práctica - Niñeces y LGBTIQ
...
### `r advdate(martes, 7)`. Unidad 3. La práctica - Pueblos originarios
...
### `r advdate(martes, 8)`. Examen final presencial
